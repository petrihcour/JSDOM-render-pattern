...
function renderBook(book) {
  ...
  // Use template literals to create the HTML for a single book
  var content = "\n    <div class=\"book\">\n      <div class=\"details\">\n        <div class=\"title\">".concat(title, "\n          <span class=\"rating\">").concat(rating, "</span>\n        </div>\n        <div class=\"authors\">").concat(authors.join(", "), "</div>\n        <div class=\"description\">").concat(description, "</div>\n        <button class=\"removeBtn\">Remove from cart</button>\n      </div>\n      <div class=\"quantity\">").concat(quantity, " @ $").concat(price.toFixed(2), "</div>\n      <div class=\"price\">($").concat((price * quantity).toFixed(2), ")</div>\n    </div>\n  ");
  return content;
}
...
*/
function render() {
  var section = document.querySelector("#cartItems");
  section.innerHTML = "";
  ...
  if (books.length === 0) {
    ...
    totalSection.innerHTML = "$0";
  } else {
    section.innerHTML = content;
    totalSection.innerHTML = "$".concat(total);
  }
}
...
*/
function main() {
  var button = document.querySelector("#sortBtn");
  button.addEventListener("click", sortByPrice);
  render();
}
